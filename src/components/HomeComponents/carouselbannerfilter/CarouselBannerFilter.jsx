...
// import "./CarrousalBannerFilter.css";
...
//                 {/* Indicators */}
//                 <div className="carousel-indicators carousel-indicators-filter">
...
// export default CarrousallBannerFilter
...
const CarrousallBannerFilter = ({ data = [] }) => {
  if (!data || data.length === 0) {
    return <div style={{ color: "gray" }}>No banner data available.</div>;
  }
            ...
            >
              {/* <img
                src={
                  item.image
                    ? `${BASE_URL}/${item.image}`
                    : "https://via.placeholder.com/1920x500.png?text=No+Banner"
                }
                className="d-block mx-auto carousel-image-banner"
                alt={`Static Offer ${index + 1}`}
                style={{
                  width: "100%",
                  objectFit: "cover",
